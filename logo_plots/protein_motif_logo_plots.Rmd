...
First we change to the directory where our R script output the instances for each motif:
...
Then we run a script called run_hmmbuild.pl which creates and runs a shell script for each motif
